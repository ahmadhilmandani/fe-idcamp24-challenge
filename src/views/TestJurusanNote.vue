    ...
    <main class="w-full min-h-screen bg-cust-orange-lightest flex justify-center items-center px-16">
      <div class="max-w-[600px] w-full flex flex-col items-center">
        <h1 class="text-[48px] text-center">
          Catatan Penting Bang!
        </h1>

        <p class="text-center text-[16px] mt-8">
        ...
        <div class="flex gap-4 mt-6 mb-14">
          <input v-model="isNoted" type="checkbox" name="isNoted" id="isNoted" class="w-5 accent-cust-blue">
          <label for="isNoted" class="text-[16px]">Oke, noted!</label>
        </div>
        ...
        <small class="text-[12px] mt-20">
          Mau tau behind the scene web ini ngerekomenin jurusan? <RouterLink to="/test-jurusan/behind-the-scene" class="text-cust-orange underline">
            Klik sini ya!</RouterLink>
        </small>
      </div>
    </main>
  </div>

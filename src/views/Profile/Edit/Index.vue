    ...
    <div class="border px-16 py-10 max-w-[600px] w-full rounded-xl">
      ...
      <div class="flex flex-wrap gap-8 mt-4">
        ...
        <div class="grow">
          ...
          <select id="cars" name="cars" v-model="originSchool"
      ...
      <div class="flex flex-wrap gap-8 mt-6 mb-12">
        ...
        <div class="grow">
          ...
          <select id="cars" name="cars" v-model="gender"
            class="w-full border p-3 rounded-md focus:outline-none focus:border-cust-orange focus:ring-cust-orange focus:ring-1">
      ...
      <div class="flex flex-wrap gap-4">
        <div class="grow">
          <ButtonComp :handleClick="() => { router.replace(`/dashboard`) }" styleProp="fill" typeProp="secondary">
            Batal
          </ButtonComp>
        </div>
        <div class="grow">
